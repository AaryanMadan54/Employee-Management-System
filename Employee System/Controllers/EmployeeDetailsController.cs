...
namespace Employee_System.Controllers
{
    ...
    public class EmployeeDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,name,email,phone,title")] EmployeeDetail employeeDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,name,email,phone,title")] EmployeeDetail employeeDetail)
        {
            if (ModelState.IsValid)
            {
